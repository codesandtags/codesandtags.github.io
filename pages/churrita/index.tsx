      ...
      <div className={styles.container}>
         ...
         <div className="w-full md:w-1/2 flex flex-col justify-center items-center	content-center mx-auto py-8">
            ...
            {seeLyrics ? (
               <div>
                  <p className="my-4">
                     BUENO no sé cómo empezar esto Es la primera vez que lo hago
                     Y más que desearte tan solo un FELIZ cumpleaños QUISIERA
                  ...
                  <p className="my-4">
                     EMPIEZO por darle gracias al cielo que hoy existes , por
                     los años que vienen, y el día en que me conociste, por cada
                     instante, por cada abrazo, por cada beso, y los recuerdos
                     felices, por los retos superados, y por cada enseñanza, por
                     cada paso a tu lado y los mensajes que aún existen, por
                     cada café que nos tomamos en la capital, por las profundas
                     conversaciones llenas de sinceridad, por cada tarde
                     contemplando el atardecer, por aquellos buenos días juntos
                     al amanecer...
                  </p>
                  ...
                  <p className="my-4">
                     ...
                     quiero es VERTE VOLAR, que cumplas todos tus sueños y lo
                     digo de verdad, NUNCA TE detengas, tu solo sigue adelante,
                     Que DIOS bendiga tu vida en en cada instante,
                  </p>

                  <p className="my-4">
                     LA VIDA continúa y si algún día miras atrás, ojalá tomes
                     impulso y sólo vuelve a recordar, que cada día que vives
                     cuenta y los segundos suman, que las tristezas te enseñan,
                     y la experiencia ayuda, que cada cosa que aprendas es una
